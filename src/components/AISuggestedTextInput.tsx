import { AILabel, AILabelContent, TextInput } from '@carbon/react';
import { useMemo, useRef, useState } from 'react';
import type { DraftProvenance } from '../types/ai';

interface AISuggestedTextInputProps {
  id: string;
  labelText: string;
  value: string;
  placeholder: string;
...
export function AISuggestedTextInput({
  id,
  labelText,
  value,
  placeholder,
